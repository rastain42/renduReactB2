...
export default function ConversationScreen({navigation}) {
  ...
  const getConversations = async () => {
    const conversations = await axios.get('https://4bc6-2a01-e0a-1d1-8260-6593-564-4d0f-ad45.eu.ngrok.io/users/' + "2b2509d9-1cb3-42b3-bffe-2a000b4ef6a2"+ '/conversations')
